...
class SecondLevelFoucs extends GetView<FoucsController> {
  const SecondLevelFoucs({super.key});
  @override
          ...
          Obx(() => Column(
                children: [
                  Padding(
                    ...
                    child: Center(
                      child: Text(
                        controller.word2Level[controller.indexLevel.value - 1],
                        style: const TextStyle(
                            fontSize: 22,
                            fontWeight: FontWeight.bold,
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                        ...
                        child: Image.asset(controller
                            .image2Level[controller.indexLevel.value - 1])),
                  ),
                ],
              )),
          Obx(() => Row(
              mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: controller.answer2Level[controller.indexLevel.value - 1]
                  .map((e) => ShapeAnswer(e))
                  .toList())),
          const SizedBox(),
        ],
