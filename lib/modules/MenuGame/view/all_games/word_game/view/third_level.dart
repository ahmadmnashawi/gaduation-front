...
class ThirdLevelWord extends GetView<SplashScreencontroller> {
  const ThirdLevelWord({super.key});
  @override
                                          ...
                                          print(controller
                                              .word3Level[
                                                  controller.indexLevel.value -
                                                      1]
                                              .first);
                                          if (controller.word3Level[controller
                                                          .indexLevel.value -
                                                      1]
                                                  .contains(singleWord) &&
