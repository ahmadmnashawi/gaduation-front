...
import 'package:graduationproject/modules/MenuGame/view/all_games/word_game/view/third_level.dart';

import '../../../../../menu/view/HomePage.dart';
import '../../../../Menu_game.dart';

class SecondLevelWord extends GetView<SplashScreencontroller> {
  const SecondLevelWord({super.key});
  @override
                                    ...
                                    onPressed: () {
                                      if (controller.time.value.toString() !=
                                        ...
                                        print(controller
                                            ...
                                            .first);
                                        if (controller.word2Level[controller
                                                        .indexLevel.value -
                                                    1]
                                                .contains(singleWord) &&
