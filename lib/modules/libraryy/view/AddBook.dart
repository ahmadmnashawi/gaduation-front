        ...
        children: [
              ...
              child: Align(
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      controller.getIdBook(
                          controller.addoneBook.value.bookName.toString());
                    },
                ...
                child: GFAccordion(
                  ...
                  contentChild: Column(
                    children: controller.AllAutour.map((element) => TextButton(
                        onPressed: () {
                          controller.writerBook.value.IdBook =
                              controller.idbook.value;
                          controller.writerBook.value.IdWriter = element.id;
                          controller.writerBook.value.writer!.writerName =
                              element.writerName;
          ...
          GFButton(
            ...
            onPressed: () {
              ...
              controller.booklibraryAdd.value.book =
                  controller.addoneBook.value;
              controller.booklibraryAdd.value.IdLibrary =
